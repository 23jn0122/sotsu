...
<body>
    ...
    <main>
        ...
        <section id="reservation-info">
            <h2>ご予約について</h2>
            <ul>
                <li>現在時刻の30分後から1か月後までの間で、受け取り日時を指定頂けます。</li>
                <li>お客様がご指定の受取り時刻から1時間を経過してもご来店されなかった場合、ご注文いただいた商品は食品安全・品質管理の観点ら廃棄させていただきます。また、商品を再度ご用意することについてはご対応いたしかねます。あらかじめご了承ください。
                </li>
                <li>ご注文に関するお問い合わせはお客様相談室 <strong>03-3369-9337</strong> までご連絡ください。</li>
            </ul>

            <h2>注文後について</h2>
            <ul>
                <li>ご注文後、内容確認のためこちらからお電話させていただく場合がございます。ご了承ください。</li>
                <li>メールアドレスご入力の誤りや、折り返しのお電話がつながらなかった場合は、ご予約を取り消させていただく場合がございます。</li>
                <li>ご注文後、<strong>[23jn0123@jec.ac.jp]</strong>から自動返信メールが届きます。迷惑メール対策設定などにより、返信メールが受け取れない場合があります。<strong>[23jn0123@jec.ac.jp]</strong>からのメールを受信できるように設定してからご予約ください。
                </li>
            </ul>

            <h2>他の説明について</h2>
            <ul>
                <li>お支払いは、商品のお受け取り時、お受け取り店舗のお支払方法からお選びいただけます。</li>
                <li>当サイトでは、JavaScript を使用しています。ブラウザ設定で JavaScript 機能を有効にしてご覧ください。</li>
            </ul>
        ...
        <div class="form-link-container">
            <a href="weborder2.php" class="form-link">次へはこちら</a>
        </div>
